...
* jsonrpc-сервис - компонент предоставляемый разработчиком, например demo-service. Он преобразует jsonrpc-сообщения в вызовы API прикладного объекта
* Прикладной объект, где реализована вся логика, например demo-domain.

```
┌─────────────┐  ┌───────────────┐  ┌──────────────┐
│ server-tcp  ├──┤ demo-service  ├──┤ demo-domain  │
└─────────────┘  └───────────────┘  └──────────────┘
```
```json
{
...
┌──────────────┐  ┌──────────────┐  ┌─────────────┐    |    ┌─────────────┐  ┌──────────────┐  ┌──────────────┐
│ demo-domain  ├──┤ hash-gateway ├──┤ client-tcp  ├ - -|- ->┤ server-tcp  ├──┤ hash-service ├──┤ hash-domain  │
└──────────────┘  └──────────────┘  └─────────────┘    |    └─────────────┘  └──────────────┘  └──────────────┘
